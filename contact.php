...
<body class="min-h-screen text-white">
    <div class="mx-auto min-h-screen max-w-full p-0 md:p-0">
        ...
        <section class="bg-white px-5 pt-[8rem] pb-12 text-black sm:px-8 md:px-12 md:pt-32 md:pb-24 lg:px-16 lg:pt-36 lg:pb-25">
            <div class="mx-auto max-w-6xl">
                ...
                <div class="grid grid-cols-1 gap-y-12 md:grid-cols-12 md:gap-x-10 lg:gap-x-16 xl:gap-x-10 items-start">
                    ...
                    <div class="order-2 md:order-none md:col-span-6 lg:col-span-5 md:col-start-7 lg:col-start-8 md:row-start-1 md:row-span-3 self-start bg-white p-6 sm:p-8 md:p-8 lg:p-8 shadow-[0_10px_60px_rgba(0,0,0,0.05)] border border-black/0 lg:mt-8">
                        ...
                        <form id="contactForm" class="space-y-5" action="send-contact.php" method="post">
                            <div class="grid gap-4 sm:grid-cols-2">
                                <input type="text" name="first_name" placeholder="First name" required class="h-12 border border-black/10 bg-transparent px-4 text-sm text-black outline-none transition placeholder:text-black/30 focus:border-black/30" />
                                <input type="text" name="last_name" placeholder="Last name" required class="h-12 border border-black/10 bg-transparent px-4 text-sm text-black outline-none transition placeholder:text-black/30 focus:border-black/30" />
                            </div>
                            ...
                            <!-- <div class="relative">
                                ...
                                <input type="email" name="email" placeholder="Your email" required class="h-12 w-full border border-black/10 bg-transparent pl-11 pr-4 text-sm text-black outline-none transition placeholder:text-black/30 focus:border-black/30" />
                            </div> -->
    ...
    <!-- Added id="emailInput" -->
    <input type="email" id="emailInput" name="email" placeholder="Your email" required class="h-12 w-full border border-black/10 bg-transparent pl-11 pr-4 text-sm text-black outline-none transition placeholder:text-black/30 focus:border-black/30" />
</div>
<script>
  // Target email elements
const emailInput = document.querySelector("#emailInput");
const emailIcon = document.querySelector("#emailIcon");

// Listen for typing events to switch icon colors dynamically
    ...
    if (emailInput.checkValidity()) {
        ...
        emailIcon.classList.add("text-black/30");
                            ...
                            <div class="relative">
                                ...
                                <!-- Hidden Input to pass the E.164 formatted number to send-contact.php -->
                            ...
                            <div class="relative">
                                <textarea name="help" rows="4" maxlength="120" placeholder="How can we help?" required class="min-h-[10rem] w-full resize-none border border-black/10 bg-transparent px-4 py-4 text-sm text-black outline-none transition placeholder:text-black/30 focus:border-black/30"></textarea>
