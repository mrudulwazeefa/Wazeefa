      ...
      <div class="mx-auto max-w-6xl">
        <div class="max-w-full">
          <nav class="flex items-center gap-x-3 text-sm text-black/60 py-4">
            ...
            <span>/</span>
            <span class="text-[#dc8413]">Ecommerce Website Development</span>
          </nav>
          <div class="py-4">
            <h1
              class="service-hero-h2 text-[2.2rem] leading-[1.05] tracking-[-0.0em] text-black sm:text-[3rem] md:text-[3.1rem] max-w-4xl">
              Ecommerce Website Development Solutions Built for Online Growth
            </h1>
            <p class="pt-4 space-y-5 text-[15px] leading-7 text-black/75">
              Powering Business Success Through Modern Ecommerce Experiences
            </p>
          </div>
              ...
              <div
                ...
                <div class="relative w-[6.8rem] h-[6.8rem] flex items-center justify-center">
                  ...
                  <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="relative w-[42px] h-[42px]">
                      <img id="shape-2" src="assets/images/icons/ecommerce.png" alt="Icon 1" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" /> 
                      <img id="shape-3" src="assets/images/icons/ecommerce2.png" alt="Icon 2" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />                      
                      <img id="shape-1" src="assets/images/icons/ecommerce3.png" alt="Icon 3" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />     
                    </div>
                  </div>
                </div>
                ...
                <div class="space-y-5 mb-5 sm:mb-6 md:mb-5 lg:mb-12">
                  ...
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    In today's fast-growing digital marketplace, a high-performing ecommerce website is essential for business success. At Wazeefa, we develop secure, scalable, and user-friendly ecommerce solutions tailored to modern business needs and customer expectations.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    We combine creative storefront design, seamless user experiences, and advanced ecommerce technologies to create online shopping platforms that drive engagement and business growth.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    Every ecommerce website we build is designed around customer behavior, smooth navigation, faster checkout experiences, mobile responsiveness, and conversion-focused functionality. With expertise in leading ecommerce technologies and platforms, we create online stores that not only look impressive but also deliver measurable business results.
                  </p>
      ...
      <div class="mx-auto w-full max-w-6xl flex-shrink-0 text-center">
        <div>
          ...
          <p class="pt-4 text-[15px] leading-6 text-white/75 mx-auto max-w-md sm:max-w-xl">
            We build powerful ecommerce platforms that enhance customer experiences, increase conversions, and support long-term business growth.
          </p>
        </div>
      </div>
      ...
      <div id="servicesHorizontalPin" class="relative mt-12 w-full flex-grow flex items-center">
        <div id="servicesHorizontalTrack" class="flex flex-nowrap w-max gap-8 px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          <article
            ...
            <svg width="42" height="42" class="card-svg" viewBox="0 0 64 64"><g><path d="M52 62H12c-1.7 0-3-1.3-3-3V25h2v34c0 .6.4 1 1 1h40c.6 0 1-.4 1-1V25h2v34c0 1.7-1.3 3-3 3zM11 11H9V5c0-1.7 1.3-3 3-3h40c1.7 0 3 1.3 3 3v6h-2V5c0-.6-.4-1-1-1H12c-.6 0-1 .4-1 1z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M10 10h44v2H10z" fill="currentColor" opacity="1" data-original="currentColor"></path><circle cx="50" cy="7" r="1" fill="currentColor" opacity="1" data-original="currentColor"></circle><circle cx="46" cy="7" r="1" fill="currentColor" opacity="1" data-original="currentColor"></circle><circle cx="42" cy="7" r="1" fill="currentColor" opacity="1" data-original="currentColor"></circle><path d="M8 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M16 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M24 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M32 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M40 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M48 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M56 27c-2.8 0-5-2.2-5-5h2c0 1.7 1.3 3 3 3s3-1.3 3-3h2c0 2.8-2.2 5-5 5zM15.066 10.617l1.856.744-4.018 10.022-1.856-.744zM21.034 10.802l1.962.392-2 10.006-1.962-.392zM27 11h2v10h-2zM36.013 10.931l1 9.95-1.99.2-1-9.95zM42.97 10.817l1.999 10.006-1.962.392-2-10.006zM48.898 10.632l4.006 10.034-1.858.742-4.006-10.034z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M3 22h58v-1.3l-6.1-10.2-1.8 1 5.1 8.5H5.8l5.1-8.5-1.8-1L3 20.7zM29 55h-3c-2.8 0-5-2.2-5-5v-2.9c0-1-.5-1.9-1.3-2.5L17.2 43l2.5-1.6c.8-.6 1.3-1.5 1.3-2.5V36c0-2.8 2.2-5 5-5h3v2h-3c-1.7 0-3 1.3-3 3v2.9c0 1.7-.8 3.2-2.2 4.1 1.4.9 2.2 2.5 2.2 4.1V50c0 1.7 1.3 3 3 3h3zM38 55h-3v-2h3c1.7 0 3-1.3 3-3v-2.9c0-1.7.8-3.2 2.2-4.1-1.4-.9-2.2-2.5-2.2-4.1V36c0-1.7-1.3-3-3-3h-3v-2h3c2.8 0 5 2.2 5 5v2.9c0 1 .5 1.9 1.3 2.5l2.5 1.6-2.5 1.6c-.8.6-1.3 1.5-1.3 2.5V50c0 2.8-2.2 5-5 5z" fill="currentColor" opacity="1" data-original="currentColor"></path></g></svg>
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
               We create secure and user-friendly ecommerce websites designed to increase online sales and improve customer experiences.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="42" height="42" class="card-svg" viewBox="0 0 60 60"><g><path d="M30.1 48.8H7.5c-2.8 0-5-2.2-5-5V11.3c0-2.8 2.2-5 5-5h45c2.8 0 5 2.2 5 5V33H55V11.3c0-1.4-1.1-2.5-2.5-2.5h-45C6.1 8.8 5 9.9 5 11.3v32.5c0 1.4 1.1 2.5 2.5 2.5h22.6z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M3.8 17.5h52.5V20H3.8zM10 38.7h11.3v2.5H10zM43.8 57.5c-9 0-16.3-7.3-16.3-16.3S34.8 25 43.8 25 60 32.3 60 41.3s-7.3 16.2-16.2 16.2zm0-30c-7.6 0-13.7 6.2-13.7 13.7S36.2 55 43.8 55s13.7-6.2 13.7-13.7-6.2-13.8-13.7-13.8zM10 31.3h5v2.5h-5zM20 31.3h5v2.5h-5z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="m42.5 49.3-9.1-9.1 1.8-1.8 7.3 7.3 9.8-9.8 1.8 1.8z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
                Payment Gateway Integration
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We integrate trusted payment gateways to deliver smooth, secure, and hassle-free online transactions.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="52" height="52" class="card-svg" viewBox="0 0 64 64"><g><path d="M45 30c-2.891 0-5.333-2.442-5.333-5.333a1 1 0 1 1 2 0C41.667 26.474 43.193 28 45 28s3.333-1.526 3.333-3.333a1 1 0 1 1 2 0C50.333 27.558 47.891 30 45 30zM27.667 30c-2.892 0-5.334-2.442-5.334-5.333a1 1 0 1 1 2 0c0 1.807 1.526 3.333 3.334 3.333C29.474 28 31 26.474 31 24.667a1 1 0 1 1 2 0C33 27.558 30.558 30 27.667 30z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M36.333 30C33.442 30 31 27.558 31 24.667a1 1 0 1 1 2 0C33 26.474 34.526 28 36.333 28c1.808 0 3.334-1.526 3.334-3.333a1 1 0 1 1 2 0c0 2.891-2.442 5.333-5.334 5.333zM19 30c-2.891 0-5.333-2.442-5.333-5.333a1 1 0 1 1 2 0C15.667 26.474 17.193 28 19 28s3.333-1.526 3.333-3.333a1 1 0 1 1 2 0C24.333 27.558 21.891 30 19 30zM53.667 30c-2.892 0-5.334-2.442-5.334-5.333a1 1 0 1 1 2 0c0 1.807 1.526 3.333 3.334 3.333C55.474 28 57 26.474 57 24.667a1 1 0 1 1 2 0C59 27.558 56.558 30 53.667 30z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M10.333 30C7.442 30 5 27.558 5 24.667a1 1 0 1 1 2 0C7 26.474 8.526 28 10.333 28c1.808 0 3.334-1.526 3.334-3.333a1 1 0 1 1 2 0c0 2.891-2.442 5.333-5.334 5.333z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M6 25.667a1 1 0 0 1-1-1V19a1 1 0 1 1 2 0v5.667a1 1 0 0 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M58 20H6a1 1 0 1 1 0-2h52a1 1 0 1 1 0 2z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M58 25.667a1 1 0 0 1-1-1V19a1 1 0 1 1 2 0v5.667a1 1 0 0 1-1 1zM6 20a.999.999 0 0 1-.707-1.707l6.828-6.829a.999.999 0 1 1 1.414 1.414l-6.828 6.829A.997.997 0 0 1 6 20z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M12.828 13.171a.999.999 0 0 1-.707-1.707A4.968 4.968 0 0 1 15.657 10a1 1 0 1 1 0 2c-.802 0-1.556.312-2.122.878a.993.993 0 0 1-.707.293z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M48.343 12H15.657a1 1 0 1 1 0-2h32.686a1 1 0 1 1 0 2zM58 20a.997.997 0 0 1-.707-.293l-6.828-6.829a.999.999 0 1 1 1.414-1.414l6.828 6.829A.999.999 0 0 1 58 20z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M51.172 13.171a.997.997 0 0 1-.707-.293A2.983 2.983 0 0 0 48.343 12a1 1 0 1 1 0-2c1.336 0 2.592.52 3.536 1.464a.999.999 0 0 1-.707 1.707zM52 54a1 1 0 1 1 0-2c.552 0 1-.449 1-1a1 1 0 1 1 2 0c0 1.654-1.346 3-3 3zM12 54c-1.654 0-3-1.346-3-3a1 1 0 1 1 2 0c0 .551.448 1 1 1a1 1 0 1 1 0 2z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M10 52a1 1 0 0 1-1-1V28.987a1 1 0 1 1 2 0V51a1 1 0 0 1-1 1zM54 52a1 1 0 0 1-1-1V32.993a1 1 0 1 1 2 0V51a1 1 0 0 1-1 1zM38 54a1 1 0 0 1-1-1V39a1 1 0 1 1 2 0v14a1 1 0 0 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M38 40a1 1 0 0 1-1-1c0-.551-.448-1-1-1a1 1 0 1 1 0-2c1.654 0 3 1.346 3 3a1 1 0 0 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M36 38h-8a1 1 0 1 1 0-2h8a1 1 0 1 1 0 2zM26 54a1 1 0 0 1-1-1V39a1 1 0 1 1 2 0v14a1 1 0 0 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M26 40a1 1 0 0 1-1-1c0-1.654 1.346-3 3-3a1 1 0 1 1 0 2c-.552 0-1 .449-1 1a1 1 0 0 1-1 1zM34 54H12a1 1 0 1 1 0-2h22a1 1 0 1 1 0 2zM52 54H38a1 1 0 1 1 0-2h14a1 1 0 1 1 0 2zM23.333 25.667a1 1 0 0 1-1-1V23a1 1 0 1 1 2 0v1.667a1 1 0 0 1-1 1zM40.667 25.667a1 1 0 0 1-1-1V23a1 1 0 1 1 2 0v1.667a1 1 0 0 1-1 1zM49.333 25.667a1 1 0 0 1-1-1V23a1 1 0 1 1 2 0v1.667a1 1 0 0 1-1 1zM32 25.667a1 1 0 0 1-1-1V23a1 1 0 1 1 2 0v1.667a1 1 0 0 1-1 1zM14.667 25.667a1 1 0 0 1-1-1V23a1 1 0 1 1 2 0v1.667a1 1 0 0 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
                Marketplace Solutions
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We build scalable multi-vendor marketplace platforms with advanced management tools and customer-focused features.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="52" height="52" class="card-svg" viewBox="0 0 64 64"><g><path d="M40.456 55.95v-4.284a1 1 0 0 0-2 0v4.284a4.055 4.055 0 0 1-4.05 4.05H10.085a4.055 4.055 0 0 1-4.05-4.05V8.05A4.055 4.055 0 0 1 10.085 4h24.32a4.055 4.055 0 0 1 4.05 4.05v2.728a1 1 0 0 0 2 0V8.05A6.057 6.057 0 0 0 34.405 2h-24.32a6.057 6.057 0 0 0-6.05 6.05v47.9a6.057 6.057 0 0 0 6.05 6.05h24.32a6.057 6.057 0 0 0 6.05-6.05z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><path d="M17.023 56.185a1 1 0 0 0 1 1h8.444a1 1 0 0 0 0-2h-8.444a1 1 0 0 0-1 1zM26.023 7.815a1 1 0 0 0-1-1h-7a1 1 0 0 0 0 2h7a1 1 0 0 0 1-1zM59.885 22.815c-.005-.013-.013-.025-.018-.038-.023-.05-.042-.102-.073-.149l-5.824-8.631a1.001 1.001 0 0 0-.829-.44H26.107a1 1 0 0 0-.829.44l-5.824 8.631c-.032.047-.05.099-.073.149-.006.013-.013.024-.018.038a.988.988 0 0 0-.074.366l-.002.009v3.285c0 1.553.744 2.922 1.88 3.814v17.203h-.88a1 1 0 0 0 0 2h38.674a1 1 0 0 0 0-2h-.88V30.288c1.136-.892 1.88-2.261 1.88-3.814v-3.285l-.002-.009a.969.969 0 0 0-.074-.366zm-1.924 3.659c0 1.581-1.287 2.867-2.868 2.867s-2.867-1.286-2.867-2.867v-2.285h5.735zm-7.735 0c0 1.581-1.287 2.867-2.868 2.867s-2.867-1.286-2.867-2.867v-2.285h5.735zm-15.47 0c0 1.581-1.286 2.867-2.867 2.867s-2.868-1.286-2.868-2.867v-2.285h5.735zm-13.47 0v-2.285h5.735v2.285c0 1.581-1.286 2.867-2.867 2.867s-2.868-1.286-2.868-2.867zm14.487-10.918-.406 3.031-.483 3.601h-5.379l2.682-6.631h3.587zm1.535 3.601.483-3.601h3.664l.623 4.645.266 1.987h-5.443l.406-3.031zm9.752-3.601 2.682 6.631h-5.38l-.623-4.645-.266-1.987h3.587zm-10.305 8.633h5.735v2.285c0 1.581-1.287 2.867-2.868 2.867s-2.868-1.286-2.868-2.867v-2.285zm20.327-2.002H51.9l-2.682-6.631h3.39l4.475 6.631zm-30.444-6.631h3.39l-2.682 6.631h-5.182l4.475-6.631zM56.08 47.489H23.167V31.24c.319.066.649.101.987.101 1.583 0 2.978-.771 3.867-1.945.89 1.174 2.285 1.945 3.868 1.945s2.978-.771 3.867-1.945c.89 1.174 2.285 1.945 3.868 1.945s2.978-.771 3.868-1.945c.89 1.174 2.284 1.945 3.867 1.945s2.978-.771 3.868-1.945c.89 1.174 2.284 1.945 3.867 1.945.338 0 .668-.035.987-.101v16.249z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We provide ongoing maintenance, updates, security monitoring, and technical support to ensure smooth ecommerce operations.
              </p>
            </div>
          </article>
      ...
      <div class="mx-auto max-w-5xl mb-10">
        <div class="mb-[5rem]">
          ...
          <h2
            ...
            Powering Online Business Growth</h2>
          <p class="text-md text-black/70 text-center max-w-3xl mx-auto">
            We develop secure and conversion-focused ecommerce platforms designed to deliver seamless shopping experiences and support online business growth.
          </p>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We understand your products, target audience, business goals, and sales strategy to create the right ecommerce solution.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Our team plans store architecture, customer journeys, payment methods, product organization, and conversion-focused ecommerce strategies.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We create user-focused layouts and shopping flows that improve navigation, engagement, and purchase experiences.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We craft visually engaging and responsive ecommerce designs that strengthen your brand and build customer trust.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We build secure, scalable, and high-performance ecommerce platforms with payment gateways, product management, and custom integrations.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We test checkout processes, responsiveness, speed, security, and usability to ensure flawless ecommerce performance.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              After final optimization and quality checks, we launch your ecommerce platform with smooth deployment and performance monitoring.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We provide ongoing updates, feature enhancements, monitoring, and technical support for long-term ecommerce success.
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-col justify-between">
          ...
          <div>
            ...
            <p class="mt-6 max-w-1xl sm:max-w-xl lg:max-w-sm text-[15px] leading-6 text-neutral-500">
              Explore a showcase of ecommerce platforms designed to improve customer experiences, increase conversions, and support scalable business growth.
            </p>
          </div>
