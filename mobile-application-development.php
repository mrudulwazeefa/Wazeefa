...
<body class="min-h-screen text-white bg-black">
  <div class="mx-auto min-h-screen max-w-full p-0 md:p-0">
    ...
    <section id="webDevHeroParallax" class="relative h-[30vh] overflow-hidden">
      <img id="webDevHeroParallaxImage" src="assets/images/banners/app-development.webp" alt="Web Development"
      ...
      <div class="mx-auto max-w-6xl">
        <div class="max-w-full">
          <nav class="flex items-center gap-x-3 text-sm text-black/60 py-4">
            ...
            <span>/</span>
            <span class="text-[#dc8413]">Mobile App Development</span>
          </nav>
          <div class="py-4">
            <h1
              class="service-hero-h2 text-[2.2rem] leading-[1.05] tracking-[-0.0em] text-black sm:text-[3rem] md:text-[3.1rem] max-w-4xl">
              Custom Mobile App Development Solutions for Business Growth
            </h1>
            <p class="pt-4 space-y-5 text-[15px] leading-7 text-black/75">
              Powering Business Growth Through Innovative Mobile Applications
            </p>
          </div>
            ...
            <div class="w-full lg:w-[100%]">
                ...
                <div class="relative w-[6.8rem] h-[6.8rem] flex items-center justify-center">
                  ...
                  <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="relative w-[42px] h-[42px]">
                      <img id="shape-2" src="assets/images/icons/mobile.png" alt="Icon 1" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" /> 
                      <img id="shape-3" src="assets/images/icons/mobile2.png" alt="Icon 2" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />                      
                      <img id="shape-1" src="assets/images/icons/mobile3.png" alt="Icon 3" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />     
                    </div>
                  </div>
                </div>
              ...
              <div class="space-y-5 mb-5 sm:mb-6 md:mb-5 lg:mb-12">
                  ...
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    In today's mobile-first world, mobile applications play a critical role in how businesses connect with customers, deliver services, and strengthen brand engagement. At Wazeefa, we develop modern, scalable, and user-focused mobile applications tailored to your business objectives.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                   We combine innovative design, advanced technologies, and strategic development to create high-performance mobile applications that deliver seamless experiences across platforms.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    From concept and UI/UX design to development and deployment, our team builds secure, reliable, and performance-driven Android and iOS applications. Whether you need a business app, eCommerce app, service platform, or custom mobile solution, we focus on creating intuitive applications that improve engagement, enhance efficiency, and support long-term business growth.
                  </p>
      ...
      <div class="mx-auto w-full max-w-6xl flex-shrink-0 text-center">
        <div>
          ...
          <p class="pt-4 text-[15px] leading-6 text-white/75 mx-auto max-w-md sm:max-w-xl">
            We build high-performance mobile applications that enhance user engagement, streamline digital experiences, and support business growth across Android and iOS platforms.
          </p>
        </div>
      </div>
      ...
      <div id="servicesHorizontalPin" class="relative mt-12 w-full flex-grow flex items-center">
        <div id="servicesHorizontalTrack" class="flex flex-nowrap w-max gap-8 px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We develop high-performance Android applications with intuitive interfaces, scalable architecture, and seamless functionality.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="42" height="42" class="card-svg" viewBox="0 0 512 512"><g><path d="M407 0H105C47.103 0 0 47.103 0 105v302c0 57.897 47.103 105 105 105h302c57.897 0 105-47.103 105-105V105C512 47.103 464.897 0 407 0zm75 407c0 41.355-33.645 75-75 75H105c-41.355 0-75-33.645-75-75V105c0-41.355 33.645-75 75-75h302c41.355 0 75 33.645 75 75v302z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M305.646 123.531c-1.729-6.45-5.865-11.842-11.648-15.18-11.936-6.892-27.256-2.789-34.15 9.151L256 124.166l-3.848-6.665c-6.893-11.937-22.212-16.042-34.15-9.151h-.001c-11.938 6.893-16.042 22.212-9.15 34.151l18.281 31.664L159.678 291H110.5c-13.785 0-25 11.215-25 25s11.215 25 25 25h189.86l-28.868-50h-54.079l85.735-148.498c3.339-5.783 4.227-12.521 2.498-18.971z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M401.5 291h-49.178l-55.907-96.834-28.867 50 86.804 150.348c3.339 5.784 8.729 9.921 15.181 11.65 2.154.577 4.339.863 6.511.863 4.332 0 8.608-1.136 12.461-3.361 11.938-6.893 16.042-22.213 9.149-34.15L381.189 341H401.5c13.785 0 25-11.215 25-25s-11.215-25-25-25zM119.264 361l-4.917 8.516c-6.892 11.938-2.787 27.258 9.151 34.15a24.837 24.837 0 0 0 12.458 3.344c8.646 0 17.067-4.484 21.693-12.495L176.999 361h-57.735z" fill="currentColor" opacity="1" data-original="currentColor"></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
                iOS App Development
              </h3>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="42" height="42" class="card-svg" viewBox="0 0 64 64"><g><path d="M35 30c1.65 0 3-1.35 3-3V5c0-1.65-1.35-3-3-3H5C3.35 2 2 3.35 2 5v22c0 1.65 1.35 3 3 3zM4 5c0-.55.45-1 1-1h30c.55 0 1 .45 1 1v6H4zm0 22V13h32v14c0 .55-.45 1-1 1H5c-.55 0-1-.45-1-1zM41 18h8c2.76 0 5 2.24 5 5v5.59l-2.29-2.29a.996.996 0 1 0-1.41 1.41l4 4c.2.2.45.29.71.29s.51-.1.71-.29l4-4a.996.996 0 1 0-1.41-1.41l-2.29 2.29V23c0-3.86-3.14-7-7-7h-8c-.55 0-1 .45-1 1s.45 1 1 1zM22.9 45.9h-8c-2.76 0-5-2.24-5-5v-5.59l2.29 2.29c.2.2.45.29.71.29s.51-.1.71-.29a.996.996 0 0 0 0-1.41l-4-4a.996.996 0 0 0-1.41 0l-4 4a.996.996 0 1 0 1.41 1.41l2.29-2.29v5.59c0 3.86 3.14 7 7 7h8c.55 0 1-.45 1-1s-.45-1-1-1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><circle cx="32.5" cy="7.5" r="1.5" fill="currentColor" opacity="1" data-original="currentColor" class=""></circle><circle cx="27.5" cy="7.5" r="1.5" fill="currentColor" opacity="1" data-original="currentColor" class=""></circle><path d="M59 34H29c-1.65 0-3 1.35-3 3v22c0 1.65 1.35 3 3 3h30c1.65 0 3-1.35 3-3V37c0-1.65-1.35-3-3-3zm-31 3c0-.55.45-1 1-1h30c.55 0 1 .45 1 1v6H28zm31 23H29c-.55 0-1-.45-1-1V45h32v14c0 .55-.45 1-1 1z" fill="currentColor" opacity="1" data-original="currentColor" class=""></path><circle cx="56.5" cy="39.5" r="1.5" fill="currentColor" opacity="1" data-original="currentColor" class=""></circle><circle cx="51.5" cy="39.5" r="1.5" fill="currentColor" opacity="1" data-original="currentColor" class=""></circle></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
                Cross-Platform App Development
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We build cross-platform mobile applications that provide consistent user experiences across Android and iOS environments.
              </p>
            </div>
          </article>
    ...
    <section class="bg-white px-5 py-20 text-black sm:px-8 md:px-12 lg:px-16">
      <div class="mx-auto max-w-5xl mb-10">
        ...
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Our team creates a detailed app development strategy covering platform selection, user flows, features, scalability, and performance objectives.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
        ...
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We build secure, scalable, and high-performance mobile applications for Android, iOS, and cross-platform environments using modern technologies.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-normal">Testing</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We conduct comprehensive testing for functionality, responsiveness, device compatibility, security, and performance optimization.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              After final quality checks and optimization, we deploy applications smoothly to app stores and production environments.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
        ...
        <div class="flex flex-col justify-between">
          ...
          <div>
            ...
            <p class="mt-6 max-w-1xl sm:max-w-xl lg:max-w-sm text-[15px] leading-6 text-neutral-500">
              Explore a showcase of high-performance mobile applications designed to improve user interaction, enhance accessibility, and support business growth across platforms.
            </p>
          </div>
        ...
        <div class="overflow-hidden">
          ...
          <div id="slider" class="flex gap-6 will-change-transform">
            ...
            <article class="relative min-w-[85%] md:min-w-[80%] flex-none overflow-hidden ">
              ...
              <img src="assets/images/caseStudies/aaa-customer.avif"
            ...
            <article class="relative min-w-[85%] md:min-w-[80%] flex-none overflow-hidden ">
              ...
              <img src="assets/images/caseStudies/beefrus.avif"
                alt="" class="h-[320px] w-full object-cover" />
            ...
            <article class="relative min-w-[85%] md:min-w-[80%] flex-none overflow-hidden ">
              ...
              <img src="assets/images/caseStudies/aaa-driver.avif"
                alt="" class="h-[320px] w-full object-cover" />
