                ...
                <div class="relative w-[6.8rem] h-[6.8rem] flex items-center justify-center">
                  ...
                  <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="relative w-[42px] h-[42px]">
                      <img id="shape-2" src="assets/images/icons/software.png" alt="Icon 1" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" /> 
                      <img id="shape-3" src="assets/images/icons/software2.png" alt="Icon 2" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />                      
                      <img id="shape-1" src="assets/images/icons/software3.png" alt="Icon 3" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />     
                    </div>
                  </div>
                </div>
