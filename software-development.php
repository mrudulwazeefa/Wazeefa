...
<body class="min-h-screen text-white bg-black">
  <div class="mx-auto min-h-screen max-w-full p-0 md:p-0">
    ...
    <section id="webDevHeroParallax" class="relative h-[30vh] overflow-hidden">
      <img id="webDevHeroParallaxImage" src="assets/images/banners/software-development.webp" alt="Web Development"
      ...
      <div class="mx-auto max-w-6xl">
        <div class="max-w-full">
          <nav class="flex items-center gap-x-3 text-sm text-black/60 py-4">
            ...
            <span>/</span>
            <span class="text-[#dc8413]">Software Development</span>
          </nav>
          <div class="py-4">
            <h1
              class="service-hero-h2 text-[2.2rem] leading-[1.05] tracking-[-0.0em] text-black sm:text-[3rem] md:text-[3.1rem] max-w-4xl">
              Custom Software Development Solutions Built for Business Growth
            </h1>
            <p class="pt-4 space-y-5 text-[15px] leading-7 text-black/75">
              Powering Business Innovation Through Smart Software Solutions
            </p>
          </div>
              ...
              <div
                ...
                <div class="flex flex-col item-left md:items-center justify-start gap-6">
                  <div class="relative w-[42px] h-[42px]">
                    <img id="shape-1" src="assets/images/icons/software.png" alt="Icon 1" 
                        class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" /> 
                    <img id="shape-2" src="assets/images/icons/software2.png" alt="Icon 2" 
                        class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />                      
                    <img id="shape-3" src="assets/images/icons/software3.png" alt="Icon 3" 
                        class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />     
                  </div>
                  <!-- <div>
                    <img 
                ...
                <div class="space-y-5 mb-5 sm:mb-6 md:mb-5 lg:mb-12">
                  ...
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    At Wazeefa, we deliver custom software solutions designed to simplify complex processes, improve productivity, and support long-term business success. Whether you're a startup, a growing company, or an established enterprise, we build software tailored to your unique business requirements.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    As a trusted software development company, we manage every stage of the development lifecycle — from planning and analysis to design, development, testing, and deployment. By combining innovative technologies with industry expertise, we create secure, scalable, and future-ready software solutions that help businesses adapt, grow, and succeed in an evolving digital landscape.
                  </p>
      ...
      <div class="mx-auto w-full max-w-6xl flex-shrink-0 text-center">
        <div>
          ...
          <p class="pt-4 text-[15px] leading-6 text-white/75 mx-auto max-w-md sm:max-w-xl">
            We build intelligent software solutions that improve efficiency, streamline operations, and support sustainable business growth.
          </p>
        </div>
      </div>
      ...
      <div id="servicesHorizontalPin" class="relative mt-12 w-full flex-grow flex items-center">
        <div id="servicesHorizontalTrack" class="flex flex-nowrap w-max gap-8 px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We develop tailored software solutions designed to optimize business operations, improve productivity, and support long-term growth.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="42" height="42" class="card-svg" viewBox="0 0 64 64"><g><path d="M52.97 43.32h-2.1c-.55 0-1-.45-1-1s.45-1 1-1h2.1c4.01 0 7.27-3.26 7.27-7.27 0-3.22-2.06-6.02-5.13-6.96-.5-.16-.8-.67-.68-1.19.11-.45.16-.95.16-1.52 0-3.97-3.22-7.24-7.17-7.29a.997.997 0 0 1-.87-.54 16.905 16.905 0 0 0-15.03-9.12c-8.12 0-15.12 5.78-16.65 13.75-.1.52-.58.87-1.11.8-.11-.01-.23-.01-.34-.01-5.33 0-9.67 4.34-9.67 9.68 0 5.33 4.34 9.67 9.67 9.67h1.04c.55 0 1 .45 1 1s-.45 1-1 1h-1.04c-6.44 0-11.67-5.24-11.67-11.67 0-6.33 5.06-11.5 11.34-11.68 2.02-8.48 9.64-14.54 18.43-14.54 6.89 0 13.17 3.7 16.52 9.69 4.76.37 8.55 4.41 8.55 9.26 0 .38-.02.75-.06 1.09 3.45 1.43 5.7 4.77 5.7 8.58.02 5.11-4.14 9.27-9.26 9.27z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M47.64 58.57H17.7c-2.34 0-4.24-1.9-4.24-4.24V32.87c0-2.34 1.9-4.24 4.24-4.24h29.94c2.34 0 4.24 1.9 4.24 4.24v21.46c0 2.34-1.9 4.24-4.24 4.24zM17.7 30.63c-1.23 0-2.24 1-2.24 2.24v21.46c0 1.23 1 2.24 2.24 2.24h29.94c1.23 0 2.24-1 2.24-2.24V32.87c0-1.23-1-2.24-2.24-2.24z" fill="currentColor" opacity="1" data-original="currentColor"></path><path d="M50.88 37.16H14.46c-.55 0-1-.45-1-1s.45-1 1-1h36.41c.55 0 1 .45 1 1s-.44 1-.99 1zM42.55 33.92h-.81c-.55 0-1-.45-1-1s.45-1 1-1h.81c.55 0 1 .45 1 1s-.45 1-1 1zM46.34 33.92h-.81c-.55 0-1-.45-1-1s.45-1 1-1h.81c.55 0 1 .45 1 1s-.45 1-1 1zM26.35 51.79c-.21 0-.43-.07-.61-.21l-4.89-3.79c-.24-.19-.38-.47-.39-.77s.13-.59.36-.79l4.89-4.08a1 1 0 1 1 1.28 1.54l-3.93 3.28 3.9 3.02c.44.34.52.97.18 1.4-.2.27-.5.4-.79.4zM29.2 54.56a1.001 1.001 0 0 1-.93-1.36l5.21-13.4c.2-.51.78-.77 1.29-.57s.77.78.57 1.29l-5.21 13.4c-.15.39-.53.64-.93.64zM37.26 51.79c-.3 0-.59-.13-.79-.39a.992.992 0 0 1 .18-1.4l3.9-3.02-3.93-3.28c-.42-.35-.48-.98-.13-1.41.35-.42.98-.48 1.41-.13l4.88 4.08c.23.19.36.48.36.79-.01.3-.15.59-.39.77l-4.88 3.79c-.18.13-.4.2-.61.2z" fill="currentColor" opacity="1" data-original="currentColor"></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-light leading-tight text-white">
                Cloud-Based Applications
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We develop secure cloud applications that provide scalability, accessibility, flexibility, and seamless business operations.
              </p>
            </div>
          </article>
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We create and integrate APIs that enable secure communication between software systems, applications, and third-party services.
              </p>
            </div>
          </article>
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We provide ongoing software maintenance, performance monitoring, updates, bug fixes, and technical support.
              </p>
            </div>
          </article>
      ...
      <div class="mx-auto max-w-5xl mb-10">
        <div class="mb-[5rem]">
          ...
          <h2
            ...
            Building Smart Software Solutions</h2>
          <p class="text-md text-black/70 text-center max-w-3xl mx-auto">
            We develop scalable and efficient software solutions designed to streamline operations, improve performance, and support business growth.
          </p>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We analyze your business requirements, operational challenges, user expectations, and project goals to understand the right software solution for your business.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Our team creates a detailed development roadmap covering system architecture, technology selection, workflows, scalability, and future business objectives.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We define software modules, features, integrations, timelines, and development priorities to ensure a structured and efficient delivery process.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We create intuitive and user-friendly interfaces focused on usability, accessibility, and seamless user experiences across platforms.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We build secure, scalable, and high-performance software using modern technologies, clean coding standards, and advanced functionality.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
             We conduct extensive testing for functionality, security, performance, reliability, and compatibility to ensure software quality and stability.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              After final optimization and validation, we deploy the software with careful configuration, monitoring, and minimal business disruption.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We provide continuous maintenance, updates, monitoring, optimization, and technical support to ensure long-term success and scalability.
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-col justify-between">
          ...
          <div>
            ...
            <p class="mt-6 max-w-1xl sm:max-w-xl lg:max-w-sm text-[15px] leading-6 text-neutral-500">
              Explore a showcase of scalable software systems and business applications developed to streamline operations, improve productivity, and support digital transformation.
            </p>
          </div>
        ...
        <div class="overflow-hidden">
          ...
          <div id="slider" class="flex gap-6 will-change-transform">
            ...
            <article class="relative min-w-[85%] md:min-w-[80%] flex-none overflow-hidden ">
              ...
              <img src="assets/images/caseStudies/mmdj.avif"
                alt="" class="h-[320px] w-full object-cover" />
