      ...
      <div class="mx-auto flex w-full max-w-6xl items-center justify-between google">
        <a href="index.php" class="flex items-center gap-2 text-xl font-medium tracking-tight sm:text-2xl">
          ...
          <span class="grid h-8 w-8 place-items-center">
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 113 124.4">
              <defs>
                <style>
                  .logo-1 {
                ...
                <linearGradient id="linear-gradient" x1="3.51" y1="-107.99" x2="-21.16" y2="-23.61"
                  gradientTransform="translate(63.17 -17.19) rotate(2.72) scale(1 -1)" gradientUnits="userSpaceOnUse">
            ...
            <div class="mega-menu-panel">
              <div class="mega-menu-panel__content mx-auto max-w-6xl py-10">
                <div class="mb-8 max-w-2xl">
                  <h2
                    class="text-[26px] font-light leading-[1.1em] tracking-[-0.0em] text-white sm:text-[32px] md:text-[38px]">
                    Comprehensive digital solutions to power your business growth</h2>
                  <p class="mt-3 text-sm text-white/70">End-to-end IT services designed to build,
                    scale, and optimize your digital presence.</p>
                </div>
                <div class="grid gap-10 md:grid-cols-3 mb-8 border-t pt-10 border-white/5">
                  <div class="space-y-4">
                  ...
                  <div class="space-y-4">
                    ...
                    <a href="ecommerce-website-development.php" class="mega-menu-link font-light">Ecommerce Development</a>
                    <a href="cms-development.php" class="mega-menu-link font-light">CMS Development</a>
                  </div>
                  <div class="space-y-4">
        ...
        <div class="hidden items-center gap-5 sm:gap-4 lg:flex">
          ...
          <a href="contact.php" class="header-action text-sm font-semibold tracking-wide">GET A QUOTE</a>
          <button id="desktopMenuButton" aria-label="Open menu"
