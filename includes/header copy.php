      ...
      <div class="mx-auto flex w-full max-w-6xl items-center justify-between">
        ...
        <nav class="hidden items-center gap-12 text-[15px] lg:flex">
          <a href="about-us.php" class="header-link header-link-muted transition hover:text-current hover:font-[450]">About</a>
           <a href="career.php" class="header-link header-link-muted transition hover:text-current hover:font-[450]">Development</a>
           <a href="career.php" class="header-link header-link-muted transition hover:text-current hover:font-[450]">E-Commerce & CMS</a>
           <a href="career.php" class="header-link header-link-muted transition hover:text-current hover:font-[450]">Business Growth</a>
        ...
        <div class="hidden items-center gap-5 sm:gap-3 lg:flex">
          ...
          <!-- <a href="contact-us.php" class="header-action text-sm font-semibold tracking-wide">GET A QUOTE</a> -->
