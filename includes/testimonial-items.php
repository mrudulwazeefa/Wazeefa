                ...
                <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                      <p class="text-base font-semibold text-black leading-tight">Sajith C.U</p>
              ...
              <article class="testimonial-slide" data-testimonial-index="1">
                ...
                <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                      <p class="text-base font-semibold text-black leading-tight">Ganji M.A</p>
              ...
              <article class="testimonial-slide" data-testimonial-index="2">
                ...
                <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                      <p class="text-base font-semibold text-black leading-tight">Ibrahim</p>
