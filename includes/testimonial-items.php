<div class="testimonial-carousel ">
  <article class="testimonial-slide is-active" data-testimonial-index="0">
    ...
    <p
      ...
      "We partnered with Wazeefa Technologies to develop our website. They communicated well throughout the project and delivered a well-designed website with an easy-to-use content management system. They were responsive, informative, and consistently delivered what was promised. We would highly recommend their services"
    </p>
    <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
      <div class="flex items-center gap-4">
        <div
          class="h-12 w-12 flex-shrink-0 overflow-hidden rounded-full bg-green-600 flex items-center justify-center">
          <span class="text-white font-bold text-lg">SA</span>
        </div>
        <div class="flex flex-col">
          <p class="text-base font-medium text-black leading-tight">Sajith C.U</p>
          <p class="mt-1 text-sm text-black/50 leading-tight">Managing Director – Poweron</p>
        </div>
      </div>
    ...
    <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
      <div class="flex items-center gap-4">
        <div
          ...
          <span class="text-white font-bold text-lg">GA</span>
        </div>
        <div class="flex flex-col">
  ...
  <article class="testimonial-slide" data-testimonial-index="2">
    ...
    <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
      <div class="flex items-center gap-4">
        <div
          class="h-12 w-12 flex-shrink-0 overflow-hidden rounded-full bg-orange-600 flex items-center justify-center">
          <span class="text-white font-bold text-lg">WA</span>
        </div>
        <div class="flex flex-col">
          <p class="text-base font-medium text-black leading-tight">Wahid</p>
  ...
  <article class="testimonial-slide" data-testimonial-index="2">
    ...
    <div class="mt-12 border-t border-black/10 pt-6 flex justify-between items-center">
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col">
          <p class="text-base font-medium text-black leading-tight">Ibrahim</p>
          <p class="mt-1 text-sm text-black/50 leading-tight">Puthiyas - Kerala</p>
        </div>
      </div>
      <div class="testimonial-quote-mark flex-shrink-0" aria-hidden="true">
        <svg class="w-5 h-5" viewBox="0 0 445.78 344.19">
