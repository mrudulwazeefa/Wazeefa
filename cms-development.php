...
<body class="min-h-screen text-white bg-black">
  <div class="mx-auto min-h-screen max-w-full p-0 md:p-0">
    ...
    <section id="webDevHeroParallax" class="relative h-[30vh] overflow-hidden">
      <img id="webDevHeroParallaxImage" src="assets/images/banners/cms-development.webp" alt="Web Development"
              ...
              <div
                ...
                <div class="relative w-[6.8rem] h-[6.8rem] flex items-center justify-center">
                  ...
                  <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="relative w-[42px] h-[42px]">
                      <img id="shape-2" src="assets/images/icons/cms.png" alt="Icon 1" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" /> 
                      <img id="shape-3" src="assets/images/icons/cms2.png" alt="Icon 2" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />                      
                      <img id="shape-1" src="assets/images/icons/cms3.png" alt="Icon 3" 
                          class="absolute inset-0 w-full h-full object-contain opacity-0 will-change-transform" />     
                    </div>
                  </div>
                </div>
                ...
                <div class="space-y-5 mb-5 sm:mb-6 md:mb-5 lg:mb-12">
                  ...
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    A powerful Content Management System (CMS) is essential for businesses looking to manage digital content efficiently and deliver engaging online experiences. At Wazeefa, we develop flexible, scalable, and user-friendly CMS solutions tailored to modern business requirements.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    We combine intuitive design, smart functionality, and reliable technologies to create CMS platforms that simplify content management and improve website performance.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    From custom CMS development to platform-based solutions, our team delivers secure and easy-to-manage systems that provide complete control over your digital content. Whether it's a corporate website, blog, ecommerce platform, or enterprise portal, we build CMS solutions that are scalable, SEO-friendly, and optimized for seamless user experiences.
                  </p>
      ...
      <div class="mx-auto w-full max-w-6xl flex-shrink-0 text-center">
        <div>
          ...
          <p class="pt-4 text-[15px] leading-6 text-white/75 mx-auto max-w-md sm:max-w-xl">
            We build flexible CMS platforms that simplify content management, improve website performance, and support long-term digital growth.
          </p>
        </div>
      </div>
        ...
        <div id="servicesHorizontalTrack" class="flex flex-nowrap w-max gap-8 px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We develop responsive and customizable WordPress websites tailored to your business and content management requirements.
              </p>
            </div>
          </article>
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                We provide ongoing CMS updates, security monitoring, maintenance, and technical support for long-term stability.
              </p>
            </div>
          </article>
    ...
    <section class="bg-white px-5 py-20 text-black sm:px-8 md:px-12 lg:px-16">
      <div class="mx-auto max-w-5xl mb-10">
        ...
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We identify your content management requirements, business workflows, and platform goals to develop the right CMS solution.
            </p>
          </div>
        </div>
        ...
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Our team plans CMS architecture, user roles, workflows, scalability, and management features for streamlined operations.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We design structured layouts and dashboard experiences that ensure intuitive navigation and efficient content management.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
        ...
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We build flexible and scalable CMS platforms with custom functionality, secure architecture, and easy content control.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We conduct detailed testing for functionality, security, responsiveness, usability, and content management performance.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Once fully optimized, we deploy the CMS platform with smooth integration, configuration, and operational setup.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We provide ongoing updates, maintenance, security monitoring, and technical assistance to ensure long-term platform efficiency.
            </p>
          </div>
        </div>
        ...
        <div class="flex flex-col justify-between">
          ...
          <div>
            ...
            <p class="mt-6 max-w-1xl sm:max-w-xl lg:max-w-sm text-[15px] leading-6 text-neutral-500">
              Explore a collection of scalable CMS platforms designed to simplify content management, improve workflow efficiency, and deliver seamless digital experiences.
            </p>
          </div>
        ...
        <div class="overflow-hidden">
          ...
          <div id="slider" class="flex gap-6 will-change-transform">
            ...
            <article class="relative min-w-[85%] md:min-w-[80%] flex-none overflow-hidden ">
              ...
              <img src="assets/images/caseStudies/lakewood.avif"
