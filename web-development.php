            ...
            <div class="w-full lg:w-[100%]">
              <div
                ...
                <!-- <div class="flex flex-col item-left md:items-center justify-start gap-6">
                    <div class="w-full lg:w-[100%]">
                      <div class="grid gap-6 md:gap-8 text-[15px] leading-7 text-black/75">
                        <div class="flex flex-row md:flex-col items-center justify-start gap-2">
                          ...
                          <div>
                            <svg id="device-icon" class="w-[6.8rem] h-[6.8rem] overflow-visible" viewBox="0 0 673.8 453.2" xmlns="http://www.w3.org/2000/svg">
                              <defs>
              ...
              <!-- <div class="flex flex-col items-start md:items-center justify-start gap-6">
                <div class="w-full lg:w-[100%]">
                  <div class="grid gap-6 md:gap-8 text-[15px] leading-7 text-black/75">
                    <div class="flex flex-row md:flex-col items-center justify-start gap-2">
                      <div class="relative w-[42px] h-[42px]">
                      ...
                      <div>
                        <svg id="device-icon" class="w-[6.8rem] h-[6.8rem] overflow-visible" viewBox="0 0 673.8 453.2" xmlns="http://www.w3.org/2000/svg">
                          <defs>
                            ...
                            <style>
                              .cls-1 { fill: none; stroke: url(#device-corner-gradient); stroke-miterlimit: 10; stroke-width: 13px; } 
                              .draw-el { stroke-linecap: round; stroke-linejoin: round; }
                            </style>
                          </defs>
                          <path class="cls-1 draw-el" d="m568,446.7H52.3c-25.3,0-45.8-20.5-45.8-45.8V52.3c0-25.3,20.5-45.8,45.8-45.8h514.5c25.3,0,45.8,20.5,45.8,45.8v18.2"/>
                          <path class="cls-1 draw-el" d="m636,420.7h-105.8c-17.3,0-31.4-14.1-31.4-31.4v-244.7c0-17.3,14.1-31.4,31.4-31.4h105.7c17.3,0,31.4,14.1,31.4,31.4v244.8c0,17.3-14,31.3-31.3,31.3Z"/>
