...
<body class="min-h-screen text-white bg-black">
  <div class="mx-auto min-h-screen max-w-full p-0 md:p-0">
    ...
    <section id="webDevHeroParallax" class="relative h-[30vh] overflow-hidden">
      <img id="webDevHeroParallaxImage" src="assets/images/branding.jpg" alt="Branding"
      ...
      <div class="mx-auto max-w-6xl">
        <div class="max-w-full">
          <nav class="flex items-center space-x-3 text-sm text-black/60 py-4">
            ...
            <span>/</span>
            <span class="text-black">Branding</span>
          </nav>
          <div class="py-4">
            <h2
              class="service-hero-h2 text-[2.2rem] leading-[1.05] tracking-[-0.0em] text-black sm:text-[3rem] md:text-[3.1rem] max-w-4xl">
              Elevating your brand with strategy, creativity, and purpose.
            </h2>
            <p class="pt-4 space-y-5 text-[15px] leading-7 text-black/75">
              We create memorable brand experiences that build trust, strengthen recognition, and drive growth.
            </p>
          </div>
              ...
              <div
                ...
                <div class="space-y-5 mb-5 sm:mb-6 md:mb-5 lg:mb-12">
                  ...
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    In a crowded marketplace, a strong and memorable brand is what sets your business apart. Effective branding goes beyond a logo — it creates a unique identity, builds trust, and establishes a lasting connection with your audience. At Wazeefa1 Technologies, we help businesses develop powerful brand identities that reflect their values, vision, and goals.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    Our branding solutions combine strategy, creativity, and market insights to create a consistent and impactful brand presence across all digital and offline touchpoints. From brand positioning and visual identity design to messaging and communication, we ensure every element works together to tell your story effectively.
                  </p>
                  <p class="text-sm leading-relaxed md:text-[15px]">
                    We focus on creating brands that resonate with customers, inspire confidence, and drive long-term recognition. By aligning your brand with customer expectations and industry trends, we help you build stronger relationships, increase brand awareness, and create a foundation for sustainable business growth.
                  </p>
                  <a href="contact.php"
        ...
        <div id="servicesHorizontalTrack" class="flex flex-nowrap w-max gap-8 px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                Build a strong foundation for your business with a clear brand vision, positioning, and strategy that helps you connect with your target audience and stand out in the market.
              </p>
            </div>
          </article>
          ...
          <article
            ...
            <div>
              ...
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                Create a unique and consistent brand identity that reflects your values, personality, and business goals, ensuring a memorable impression across all touchpoints.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
FF" class=""></path><path d="M72.416 17.573c.783.782.783 2.045 0 2.827s-2.045.782-2.828 0L59.176 9.988a1.997 1.997 0 0 1 0-2.827 1.997 1.997 0 0 1 2.827 0zM47.135 33.861a2 2 0 0 1-1.035-2.625 2 2 0 0 1 2.625-1.035c5.818 2.531 12.111 8.255 16.49 17.146 3.477 7.068 5.768 16.162 5.668 27.27a1.99 1.99 0 0 1-2.008 1.975 1.984 1.984 0 0 1-1.975-2.008c.094-10.418-2.039-18.906-5.264-25.47-3.931-7.976-9.447-13.056-14.501-15.253z" fill="#FFF" opacity="1" data-original="#FFF" class=""></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-normal leading-tight text-white">
                Communication Strategy
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                Develop clear messaging that communicates your brand story, strengthens customer relationships, and delivers a consistent voice across channels.
              </p>
            </div>
          </article>
          ...
          <article
            class="services-horizontal-card relative isolate flex w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 flex-col justify-between gap-4 overflow-hidden p-8 md:min-h-[45vh] lg:p-12 bg-white/5 border border-white/5">
            <div class="bottom-line absolute bottom-0 left-0 h-[3px] bg-white"></div>
            <svg width="42" height="42" class="card-svg" viewBox="0 0 128 128" ><g><path d="m126.89 93.13-13.12-6.56-8.35-21.72a2 2 0 0 0-1.12-1.14L52.49 43a2 2 0 0 0-2.15.44l-6.91 6.91a2 2 0 0 0-.43 2.14l20.71 51.81a2 2 0 0 0 1.14 1.12l21.72 8.35 6.56 13.12A2 2 0 0 0 94.6 128a1.73 1.73 0 0 0 .32 0 2 2 0 0 0 1.41-.59l31.08-31.08a2 2 0 0 0 .59-1.73 2 2 0 0 0-1.11-1.47zm-79.7-40.9 1.11-1.1 25.79 25.79a11.77 11.77 0 1 0 2.83-2.83L51.13 48.3l1.1-1.11L102 67.1l7.85 20.42-22.33 22.33L67.1 102zm36.51 23.7a7.77 7.77 0 1 1-5.5 2.27 7.78 7.78 0 0 1 5.5-2.27zm11.77 46.69-5-10 22.13-22.13 10 5z" fill="#FFF" opacity="1" data-original="#FFF"></path><path d="M38.25 107a2.06 2.06 0 0 0-2.83 0l-2.54 2.54a54.91 54.91 0 0 1-1-63.74 10.26 10.26 0 0 0 13.96-13.89 54.91 54.91 0 0 1 63.74 1L107 35.42a2 2 0 0 0-.58 1.41 2 2 0 0 0 .58 1.42l8.82 8.75a2 2 0 0 0 2.82 0l8.77-8.77a2 2 0 0 0 0-2.83l-8.77-8.77a2 2 0 0 0-2.82 0L112.43 30a58.91 58.91 0 0 0-59.1-6.87l11.53-11.5A6.13 6.13 0 1 0 62 8.8L42.54 28.29a10.27 10.27 0 0 0-14.25 14.25L8.8 62a6.14 6.14 0 1 0 2.83 2.83l11.53-11.5a58.91 58.91 0 0 0 6.84 59.1l-3.38 3.39a2 2 0 0 0 0 2.82l8.77 8.77a2 2 0 0 0 1.41.59 2 2 0 0 0 1.42-.59l8.78-8.77a2 2 0 0 0 0-2.82zm79-76.15 5.94 5.94-5.94 5.94-5.94-5.94zM66 4.63a2.13 2.13 0 1 1 0 3 2.12 2.12 0 0 1 0-3zM32.4 32.4a6.25 6.25 0 0 1 8.86 0 6.27 6.27 0 1 1-8.86 0zM7.64 69a2.13 2.13 0 0 1-3-3 2.14 2.14 0 0 1 3 0 2.12 2.12 0 0 1 0 3zm29.19 54.13-5.94-5.94 5.94-5.94 5.94 5.94z" fill="#FFF" opacity="1" data-original="#FFF"></path></g></svg>
            <div>
              <h3 class="text-xl md:text-[1.4rem] tracking-[-0.02em] font-normal leading-tight text-white">
                Graphic Design
              </h3>
              <p class="mt-3 text-[15px] leading-relaxed text-white/70">
                Transform ideas into compelling visual assets through creative design solutions that elevate your brand and support your marketing efforts.
              </p>
            </div>
          </article>
        </div>
      ...
      <div class="mx-auto max-w-5xl mb-10">
        <div class="mb-[5rem]">
          ...
          <p class="text-md text-black/70 text-center max-w-3xl mx-auto">
            Through collaboration and creativity, we build authentic brand experiences that resonate with customers and strengthen market presence.
          </p>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Brand Discovery</span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We begin by understanding your business, objectives, target audience, and industry landscape. This discovery phase helps us uncover your unique strengths, challenges, and opportunities, creating a solid foundation for building a meaningful and effective brand.
            </p>
          </div>
        </div>
        ...
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Research & Analysis</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Our team conducts in-depth research into your competitors, market trends, and customer behavior. These insights help us identify opportunities for differentiation and ensure your brand is positioned strategically within your industry.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Brand Strategy</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              We develop a comprehensive brand strategy that defines your positioning, core values, mission, vision, and messaging. This strategic framework serves as the roadmap for creating a consistent and impactful brand experience.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Identity Development</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Using the brand strategy as a guide, we craft the key visual and verbal elements that shape your brand's personality. This includes defining how your brand looks, sounds, and communicates with its audience across all touchpoints.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Logo & Visual Design</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
             We design distinctive logos, color palettes, typography, and supporting visual assets that reflect your brand identity. Every design element is carefully created to enhance recognition, credibility, and long-term brand consistency.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Brand Guidelines</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
             To maintain a cohesive brand presence, we develop detailed brand guidelines that outline the correct use of logos, colors, typography, imagery, and messaging. These standards ensure consistency across all marketing and communication channels.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Implementation & Rollout</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
             Once the brand identity is finalized, we apply it across digital platforms, marketing materials, and business assets. This ensures a seamless brand experience that strengthens recognition and creates a professional, unified presence.
            </p>
          </div>
        </div>
        <div class="accordion-item border-b border-black/10">
          <button class="accordion-header flex w-full items-center justify-between py-6 text-left">
            <span class="text-lg font-medium">Brand Growth & Support</span>
            <div class="icon-wrapper relative h-6 w-6">
              <span class="absolute left-1/2 top-1/2 h-0.5 w-4 -translate-x-1/2 -translate-y-1/2 bg-black"></span>
              <span
                class="vertical-line absolute left-1/2 top-1/2 h-4 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-black transition-transform duration-300"></span>
          ...
          <div class="accordion-content h-0 overflow-hidden">
            <p class="pb-6 text-black/70 leading-relaxed">
              Branding is an ongoing process. We provide continuous support, creative guidance, and strategic recommendations to help your brand adapt to changing market demands, strengthen customer relationships, and achieve sustainable growth.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col justify-between">
          ...
          <div>
            ...
            <p class="mt-6 max-w-1xl sm:max-w-xl lg:max-w-sm text-[15px] leading-6 text-neutral-500">
              Explore our branding work designed to build trust, increase visibility, and help businesses stand out in competitive markets.
            </p>
          </div>
